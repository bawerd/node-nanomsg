...
function Socket (type, opts) {
    ...
    if (this.receiver){
      if (type == 'pull'){
        this._startPullReceive();
        this._read = function (n) {
          return this.push(this._receive());
        }
      } else {
...
Socket.prototype._startPullReceive = function () {
...
Socket.prototype._startPollReceive = function () {
    if (!this._pollReceive) {
        this._pollReceive = nn.PollReceiveSocket(this.binding, function (events) {
            if (events) process.nextTick(read.bind(this));
        }.bind(this));
    }
}

function read(){
  this.push(this._receive())
}
